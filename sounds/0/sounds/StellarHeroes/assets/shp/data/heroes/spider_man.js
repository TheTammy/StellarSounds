function init(hero) {
    hero.setName("Spider-Man Animation Tester");
    hero.setVersion("Animation Testing");
    hero.setTier(10);
    ...
    hero.addPowers("fiskheroes:spider_physiology", "fiskheroes:web_shooters", "fiskheroes:web_wings");
